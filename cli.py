...
def cmd_audit(file_path: str, xsd_path: str | None, no_fail: bool) -> int:
    """Run full audit on file; print CRITICAL/WARNING counts; exit 1 if any FAIL (unless no_fail)."""
    _ensure_path()
...
def main() -> int:
    ...
    audit_p.set_defaults(func=lambda a: cmd_audit(a.file, a.xsd, a.no_fail))
